      ...
      <div className="about-cards">
        <div className="about-item">
          ...
          <p className="about-item__text">
            ...
            Создала игру Аудиовызов и держала руку на пульсе на протяжении всей разработки.
          </p>
        </div>
        <div className="about-item">
          ...
          <p className="about-item__text">
            ...
            и внес огромный вклад в создание приложения. Создал страницу
            Учебник и Статистика.
          </p>
        </div>
        <div className="about-item">
          ...
          <p className="about-item__text">
            ...
            Создала игру Спринт и Регистрацию пользователя.
            Сделала техническую часть страницы Статистика.
          </p>
        </div>
      </div>
    </section>
