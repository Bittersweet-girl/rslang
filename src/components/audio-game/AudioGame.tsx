...
export default function AudioGame({ onPlayClick }: IAudioProps) {
  ...
  return (
    <div className="audio-game-main">
      ...
      <button type="button" className="audio-game__start btn" disabled={isDisabled} onClick={onPlayClick}>Начать</button>
    </div>
  );
}
